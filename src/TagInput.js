...
const TagInput = ({handleInputChange, handleInputSubmit, handleInputDelete, inText, onKeyDown}) => {

    
    return <tr className='trData' style={{"display": "flex", "justifyContent": "space-between", "paddingBottom": "5px", "alignItems": "flex-end"}}>
        <td style={{"padding": "5px"}}><input value={inText} onKeyDown={onKeyDown} onChange={handleInputChange}/></td>
